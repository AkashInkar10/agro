        ...
        <div className="blog-page">
            ...
            <div className="fixed-top">
                <nav className="navbar">
                    <div className="logo">
                        <img src="/assets/v366_592.png" alt="AgroPrime Logo" />
            ...
            <div className="scrollable-content">
                <section className="featured-article">
                    ...
                    <div className="article-card" >
                        <img src="/assets/WhatsApp Image 2025-07-25 at 11.31.55_bda93264.jpg" alt="Featured Farm" />
                ...
                <section className="latest-articles">
                    ...
                    <div className="article-card">
                        ...
                        <img src="/assets/WhatsApp Image 2025-07-25 at 11.31.56_2be8297a.jpg" alt="Soil Health" />
                    </div>
                    <div className="article-card">
                        <div className="article-content">
                        ...
                        <img src="/assets/WhatsApp Image 2025-07-25 at 13.17.12_bc7df9e9.jpg" alt="Market Trends" />
                    </div>
                    <div className="article-card">
                        <div className="article-content">
                        ...
                        <img src="/assets/WhatsApp Image 2025-07-25 at 13.17.14_b6e47700.jpg" alt="Irrigation" />
                    </div>
                    ...
                    <div className="article-card">
                        ...
                        <img src="/assets/WhatsApp Image 2025-07-25 at 13.17.13_16ea28ce.jpg" alt="Market Trends" />
                    </div>
                </section>
            </div>
        </div>
